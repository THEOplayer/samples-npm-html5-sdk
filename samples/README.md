...
* I'm struggling with setting up THEOplayer through NPM on other projects. What are some common problems?
  1. THEOplayer requires [web workers](https://docs.theoplayer.com/getting-started/01-sdks/01-web/00-getting-started-extended.md#configure-library-location) to playback HLS streams.
  The related files are located in your `/node_modules/theoplayer` folder, and it's likely that your project isn't setup in a way that these files are accessible during client-side rendering.
  The samples in this project work around this by copying the THEOplayer library files from `/node_modules/theoplayer` to a public folder that is accessible during client-side rendering.
